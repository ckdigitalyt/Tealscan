      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <FadeInSection direction="left" delay={0.2}>
            <div className="glass-card rounded-2xl p-8 border border-neon-orange/30 bg-neon-orange/5 relative overflow-hidden h-full">
              ...
              <div className="relative">
                ...
                <div className="space-y-4 mb-6">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-white font-semibold">₹<AnimatedNumber value={1000000} /></span>
                  </div>
                  <div className="flex justify-between items-center">
                  ...
                  <div className="flex justify-between items-center border-t border-white/10 pt-4">
                    ...
                    <span className="text-neon-orange font-bold text-xl">₹<AnimatedNumber value={25000} />/yr</span>
                  </div>
                </div>

                <div className="text-center p-4 bg-neon-orange/10 rounded-xl">
                  <p className="text-sm text-gray-400 mb-1">30-Year Cost</p>
                  <p className="text-2xl font-bold text-neon-orange">₹<AnimatedNumber value={750000} />+</p>
                </div>
              </div>
            </div>
          </FadeInSection>
          ...
          <FadeInSection direction="right" delay={0.4}>
            <div className="glass-card rounded-2xl p-8 border border-neon-green/30 bg-neon-green/5 relative overflow-hidden h-full">
              ...
              <div className="relative">
                ...
                <div className="space-y-4 mb-6">
                  ...
                  <div className="flex justify-between items-center border-t border-white/10 pt-4">
                    <span className="text-gray-400">Annual Fees</span>
                    <span className="text-neon-green font-bold text-xl">₹<AnimatedNumber value={5000} />/yr</span>
                  </div>
                </div>

                <div className="text-center p-4 bg-neon-green/10 rounded-xl">
                  <p className="text-sm text-gray-400 mb-1">30-Year Cost</p>
                  <p className="text-2xl font-bold text-neon-green">₹<AnimatedNumber value={150000} /></p>
                </div>
              </div>
            </div>
          </FadeInSection>
        ...
        <FadeInSection delay={0.6} fullWidth>
          <div className="mt-8 glass-card rounded-2xl p-8 border border-neon-green/50 bg-gradient-to-r from-neon-green/10 to-accent/10 text-center">
            <p className="text-gray-300 mb-2">Your Potential Savings</p>
            <div className="flex items-center justify-center gap-4 flex-wrap">
              <div>
                <p className="text-sm text-gray-400">Annual</p>
                <p className="text-3xl font-bold text-neon-green">₹<AnimatedNumber value={20000} /></p>
              </div>
              <motion.div 
              ...
              <div>
                ...
                <p className="text-4xl font-bold text-neon-green">₹<AnimatedNumber value={1500000} duration={2500} />+</p>
              </div>
            </div>
            <p className="text-sm text-gray-500 mt-4">*Based on ₹10L investment with compound growth</p>
          </div>
        </FadeInSection>
      </div>
    </section>
