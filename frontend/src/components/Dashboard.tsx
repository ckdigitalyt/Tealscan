    ...
    >
      <div className="max-w-7xl mx-auto space-y-6">
        <motion.div
          ...
          className="bg-slate-900 rounded-3xl p-6 sm:p-8 text-white shadow-2xl"
        >
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div>
              ...
              <p className={`text-sm ${data.total_gain_percent >= 0 ? "text-emerald-400" : "text-red-400"}`}>
                {data.total_gain_percent >= 0 ? "+" : ""}{data.total_gain_percent.toFixed(2)}%
              </p>
            </div>
            
            <div>
              <p className="text-slate-400 text-sm mb-1">Hidden Commissions</p>
              <div className="flex items-center gap-2">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          >
            <div className="flex items-center gap-3 mb-2">
              ...
              <p className="text-sm text-slate-500">Funds Scanned</p>
            </div>
          ...
          >
            <div className="flex items-center gap-3 mb-2">
              ...
              <p className="text-sm text-slate-500">Direct Plans</p>
            </div>
          ...
          >
            <div className="flex items-center gap-3 mb-2">
              ...
              <p className="text-sm text-slate-500">Regular Plans</p>
            </div>
          ...
          >
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center p-3 rounded-xl bg-slate-50">
                ...
                <span className="font-semibold text-slate-900">{data.asset_allocation.Equity}%</span>
              </div>
              <div className="flex justify-between items-center p-3 rounded-xl bg-slate-50">
                <span className="text-slate-600">Debt Allocation</span>
                <span className="font-semibold text-slate-900">{data.asset_allocation.Debt}%</span>
              </div>
              <div className="flex justify-between items-center p-3 rounded-xl bg-slate-50">
                <span className="text-slate-600">Gold Allocation</span>
                <span className="font-semibold text-slate-900">{data.asset_allocation.Gold}%</span>
              </div>
              <div className="flex justify-between items-center p-3 rounded-xl bg-primary/5 border border-primary/20">
                <span className="text-primary font-medium">Direct Plan Ratio</span>
